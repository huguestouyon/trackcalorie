...
if (!empty($_POST)) {
    ...
    if(isset($_POST["lastname"], $_POST["name"], $_POST["email"], $_POST["pass"], $_POST["confirmpass"], $_POST["height"], $_POST["weight"], $_POST["sex"]) && !empty($_POST["lastname"]) && !empty($_POST["name"]) && !empty($_POST["email"]) && !empty($_POST["pass"]) && !empty($_POST["confirmpass"]) && !empty($_POST["height"]) && !empty($_POST["weight"]) && !empty($_POST["sex"]) && $_POST["pass"] === $_POST["confirmpass"]) {
